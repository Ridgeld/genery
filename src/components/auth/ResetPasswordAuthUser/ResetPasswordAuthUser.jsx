...
import styles from './ResetPasswordAuthUser.module.scss'
...
export default function ResetPasswordAuthUser() {
    ...
    const handleResetPassword = async (e) => {
        ...
        try {
            await sendPasswordResetEmail(ga, authUser.email);
            ...
            <form className={styles['auth-form']} 
                ...
                <div className={styles['greeting']}>
                    <h2 className={styles['greeting-title']}
                        ...
                        }}>Мы отправим письмо на ваш email</h2>
                    <h3 className={styles['greeting-text']}
                        style={{
                            color: theme.text_first_color
                        }}>Перейдите по ссылке в письме для сброса пароля</h3>
                </div>
