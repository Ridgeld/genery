    ...
    const footerItems = [
        ...
        { icon: 
            <svg width="26" height="27" viewBox="0 0 26 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M1.5 17.9721L7.88889 11.5832C9.07467 10.4422 10.5364 10.4422 11.7222 11.5832L16.8333 16.6944" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M15.5557 15.4167L16.8334 14.1389C17.6883 13.3173 18.6862 13.0873 19.619 13.4489M21.9446 17.9723L19.389 21.8056H24.5001L21.9446 25.6389" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>, 
          link: '#/posts' },
        { icon: 
            <svg width="26" height="17" viewBox="0 0 26 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1 1.5H25" stroke="white" strokeWidth="2" strokeLinecap="round"/>
                <path d="M1 8.5H25" stroke="white" strokeWidth="2" strokeLinecap="round"/>
                <path d="M1 15.5H25" stroke="white" strokeWidth="2" strokeLinecap="round"/>
            </svg>, 
          link: '#/list-menu' },
