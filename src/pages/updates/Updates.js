const updates = [
    {
        data: '11.03.2025',
        update: 'Добавлена возможность генерировать QR в расписании для отметки посещения в АВН',
        corrections: 'Исправлено отображение фотографий в окне просмотра'
    },
    {
        data: '23.11.2025',
        update: 'Добавлена ссылка на wiki страницу Эльдана',
    },
    {
        data: '09.11.2025',
        update: 'Добавлен чат с нейросетью',
        corrections: 'Исправлена ошибка доступа к странице поста'
    },
    {
        data: '25.05.2025',
