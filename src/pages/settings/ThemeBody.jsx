...
function ThemeBody({name, img, activeTheme , onThemeChange }){
    ...
    return(
        ...
        style={{
            border: activeTheme === name ? '2px solid var(--first-color)' : 'none'
        }}
        onClick={handleClick}>
