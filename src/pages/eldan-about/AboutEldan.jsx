...
import styles from './AboutEldan.module.scss';
import { ElementContext } from '../../providers/ElementProvider';
import { useNavigate } from 'react-router-dom';

export default function AboutEldan(){
    ...
    return(
        <div className={styles['container']}>
            <iframe className={styles['game']} src="https://ridgeld.github.io/eldan_gallery/"></iframe>
