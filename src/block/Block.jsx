        ...
        <div className={styles.block} 
            ...
            <div className={styles.info}>
                <div className={styles.title} 
                     style={{color: isLightColor(backgroundColor) ? '#000' : '#fff'}}>{name}</div>
                <div className={styles.text} 
                     style={{color: isLightColor(backgroundColor) ? '#000' : '#fff'}}> {description} </div>
            </div>
